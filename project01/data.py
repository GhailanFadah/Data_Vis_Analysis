...
class Data:
    ...
    def read(self, filepath):
        ...
        if type_list[0] != "string" and type_list[0] != "numeric" and type_list[0] != "enum" and type_list[0] != "date":
            print("the CSV file is missing the data type line. please add it and try again")
            exit()
       ...
       # makes sure each header in the headers list is of type numeric
        ...
        self.data = np.array( self.data, np.float16)
